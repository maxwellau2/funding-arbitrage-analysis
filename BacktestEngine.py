...
class Engine:
    ...
    def pre_timestep_hook(self, idx:pd.Timestamp):
        ...
        for position in self.positions.positions:
            ...
            usd_value = position.get_usd_value()
            # add to pnl
            # check position type
...
# Sharpe Ratio: 20.570906148736558 Holding Period: 20 Assets: 10
# Sharpe Ratio: 18.497153257581967 Holding Period: 10 Assets: 30
# Sharpe Ratio: 18.366400291986185 Holding Period: 20 Assets: 30
# Sharpe Ratio: 18.13032926303009 Holding Period: 15 Assets: 60
# Sharpe Ratio: 17.736989193917235 Holding Period: 5 Assets: 40
